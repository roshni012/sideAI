...
import { signupUser, getGoogleClientId, loginWithGoogleToken, getCurrentUser } from '../lib/authService';
            ...
            >
              ...
              <div className="p-8">
                ...
                <p className="text-gray-600 dark:text-gray-400 mb-6">
                  Create your account and enjoy <span className="font-bold text-green-600">30 free</span> credits daily.
                </p>
